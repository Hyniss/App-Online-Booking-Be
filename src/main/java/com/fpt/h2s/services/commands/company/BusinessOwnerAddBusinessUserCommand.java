...
public class BusinessOwnerAddBusinessUserCommand implements BaseCommand<BusinessOwnerAddBusinessUserCommand.Request, Void> {
    ...
    public ApiResponse<Void> execute(final Request request) {
        ...
        final User user = request.toBusinessUser(company.getId());
    ...
    private Integer getCompanyId() {
        ...
        final User businessOwner = this.userRepository.findById(ownerId)
                .orElseThrow(() -> ApiException.badRequest("Không thể tìm thấy người dùng với id = {}.", ownerId));
        return businessOwner.getCompanyId();
    }
    ...
    public static class Request extends BaseRequest {
        ...
        public User toBusinessUser(Integer companyId) {
            return User.builder()
                    .email(this.email)
                    .phone(this.toPhone())
